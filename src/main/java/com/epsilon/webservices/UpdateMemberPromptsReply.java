...
@XmlRootElement(name = "UpdateMemberPromptsReply")
public class UpdateMemberPromptsReply {
    ...
    @XmlElement(name = "CheckoutPrompt", required = true)
    protected UpdateMemberPromptsReply.CheckoutPrompt checkoutPrompt;
     ...
     * @return
     *     possible object is
     *     {@link UpdateMemberPromptsReply.CheckoutPrompt }
     *     
     */
    public UpdateMemberPromptsReply.CheckoutPrompt getCheckoutPrompt() {
     ...
     *     
     */
    public void setCheckoutPrompt(UpdateMemberPromptsReply.CheckoutPrompt value) {
