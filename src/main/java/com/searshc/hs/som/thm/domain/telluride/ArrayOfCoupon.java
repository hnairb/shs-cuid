 ...
 *       &lt;sequence>
 *         &lt;element name="Coupon" type="{http://www.epsilon.com/webservices/}Coupon" maxOccurs="unbounded" minOccurs="0" form="qualified"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfCoupon {
     ...
     * 
     */
    public List<Coupon2> getCoupon() {
        if (coupon == null) {
            coupon = new ArrayList<Coupon2>();
        }
        return this.coupon;
    }
