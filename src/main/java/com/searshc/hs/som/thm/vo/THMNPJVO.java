...
/**
 * VO class for NpjVO object
 * This bean is populated when the corresponding
 * input reader is called from corresponding NPJ job
 * 
 * @author Ranjit Bhakta
 * @version 1.0, Mar 03, 2014
 *
 */
public class THMNPJVO extends THMCustomerVOSellingInfo {
	...
	public String getAggrementSFX() {
		return aggrementSFX;
	}

	public void setAggrementSFX(String aggrementSFX) {
		this.aggrementSFX = aggrementSFX;
	}
